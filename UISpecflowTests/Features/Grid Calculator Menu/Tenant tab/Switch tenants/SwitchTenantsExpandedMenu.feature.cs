...
namespace UISpecflowTests.Features.GridCalculatorMenu.TenantTab.SwitchTenants
{
    ...
    [NUnit.Framework.DescriptionAttribute("SwitchTenantsExpandedMenu")]
    [NUnit.Framework.CategoryAttribute("TenantTabTests")]
    public partial class SwitchTenantsExpandedMenuFeature
    {
...
#line 1 "SwitchTenantsExpandedMenu.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Grid Calculator Menu/Tenant tab/Switch tenants", "SwitchTenantsExpandedMenu", "A short summary of the feature", ProgrammingLanguage.CSharp, featureTags);
...
#line 109
 testRunner.When("I find on the map the place where right PowerTransformers that has the required d" +
                        "ata for the calculation is located", ((string)(null)), table11, "When ");
#line hidden
#line 114
...
#line 120
 testRunner.And("Have one of the names", ((string)(null)), table12, "And ");
#line hidden
#line 125
