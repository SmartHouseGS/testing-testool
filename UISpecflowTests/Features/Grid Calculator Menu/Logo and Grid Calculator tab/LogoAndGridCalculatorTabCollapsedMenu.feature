Feature: LogoAndGridCalculatorTabCollapsedMenu

A short summary of the feature

@regression
Scenario: Verify that after clicking the Volue logo the Grid Calculator page is refreshed in the collapsed menu
...
@regression
Scenario: Verify that after changing the tenant and then clicking the Volue logo, the Grid Calculator page is refreshed in the collapsed menu
	Given I navigate to GC application
	When I Open the Grid Calculator application
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed	
...
@regression
Scenario: Verify that after clicking on one of the power grid object on the map and displaying the Select asset pop-up window and then clicking the Volue logo, the Grid Calculator page is refreshed in the collapsed menu
	Given I navigate to GC application
	When I Open the Grid Calculator application
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed
...
@regression
Scenario: Verify that after selecting one of the power grid objects and displaying the pop-up window with information about it and then clicking the Volue logo, the Grid Calculator page is refreshed in the collapsed menu
	Given I navigate to GC application
	When I Open the Grid Calculator application
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed
	Given Click one of the power grid objects - collapsed
	...
	@regression @repair
Scenario: Verify that after selecting one power transformer that has the required data for the calculation and running calculation and then clicking the Volue logo, the Grid Calculator page is refreshed in the collapsed menu
	Given I navigate to GC application
	When I Open the Grid Calculator application
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed
...
@regression
Scenario: Verify that after changing the zoom and position and then clicking the Volue logo, the Grid Calculator page is refreshed in the collapsed menu
	Given I navigate to GC application
	When I Open the Grid Calculator application
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed		
