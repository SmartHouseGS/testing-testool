@TenantTabTests
Feature: SwitchTenantsCollapsedMenu

A short summary of the feature

@regression
Scenario: Verify that after opening the Grid Calculator application, the first tenant from the tenant's list is checked and the power grid objects display on the map
	...
	When I verify that the first tenant from the list "nsa_dev" is checked
	Then The first tenant from the list "nsa_dev" is checked	
	When I verify that the power grid objects display on the map
	Then The power grid objects are displayed on the map

@regression
Scenario: Switch the tenant to the second from the list
	Given I navigate to GC application
	When I Open the Grid Calculator application	
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed						
	...
	When I click the tenant icon in the menu
	Then The tooltip with the list of available organizations and tenants with a checked active tenant "Grid Calculator Demo" is displayed

@regression
Scenario: Switch the tenant to the second from the list and then to the first from the list again
	Given I navigate to GC application
	When I Open the Grid Calculator application	
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed						
	Given Second tenant - collapsed
	...
	When I click the tenant icon in the menu
	Then The tooltip with the list of available organizations and tenants with a checked active tenant "Grid Calculator Demo" is displayed
	When I Hover over the first tenant from the list
	Then The hovering over tenant is highlighted in green
	When I click the first tenant "nsa_dev" from the list
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed
	When I click the tenant icon in the menu
	Then The tooltip with the list of available organizations and tenants with a checked active tenant "nsa_dev" is displayed

@regression
Scenario: Switch the tenant to the second from the list after clicking on one of the power grid object on the map and displaying the Select asset pop-up window
	Given I navigate to GC application
	When I Open the Grid Calculator application	
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed							
...
@regression
Scenario: Switch the tenant to the second from the list after selecting one of the power grid objects and displaying the pop-up window with information about it
	Given I navigate to GC application
	When I Open the Grid Calculator application	
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed								
	Given Click one of the power grid objects - collapsed
...
@regression
Scenario: Switch the tenant to the second from the list after selecting one of the PowerTransformers that has the required data for the calculation and displaying the pop-up window with information about it and running calculation
	Given I navigate to GC application
	When I Open the Grid Calculator application	
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed									
#made 3 tests instead of table in design
	...
	@regression
Scenario: Switch the tenant to the second from the list after changing the zoom and position
	Given I navigate to GC application
	When I Open the Grid Calculator application	
	Then The page displays the messages "Authenticating" and/or "Loading map configuration" for a few seconds, then the Grid Calculator application is displayed						
